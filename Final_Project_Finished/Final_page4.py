...
#Get the html
result = requests.get("https://www.como.gov/CMS/health_inspections/?type=RESTAURANT&offset=300")
...
#Get the text I need; replace the elements I don't want and turn the "Resultset" type to string
